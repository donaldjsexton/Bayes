...
class Search():
    ...
    def __init__(self, name):
        ...
        self.sa3 = self.img[SA3_CORNERS[1]: SA2_CORNERS[3], SA3_CORNERS[0]: SA3_CORNERS[2]]
    ...
    def sailor_final_location(self, num_search_areas):
        ...
        # Find sailor coordinates with respect of any Search Area subarray.
...
def main():
    ...
    while True:
        ...
        if results_1 == 'Not Found' and results_2 == 'Not Found':
            print("\nNew Target Probabilities (P) for Search {}:".format(app.p1, app.p2, app.p3))
        else:
